...
import { buildDecalLayout, gizmoCursor, hitTestDecal, useDecalTexture } from '@hooks';
import { clampDecalScale, setOrbitLockedByNameTool } from '@utils';
import { DECAL_SCALE_MAX, DECAL_SCALE_MIN } from '@constants';
import type { GizmoHandle, GizmoZone, NumberInstance } from '@types';
