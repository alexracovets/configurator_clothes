...
export { TEXTURE_SIZE_EDITOR, TEXTURE_SIZE_EXPORT, TEXTURE_SIZE_MOBILE, TEXTURE_SIZE_DRAG, UV0_BOUNDS, PRINT_ZONES, Z_LAYER_PATTERN, Z_LAYER_NUMBERS, Z_LAYER_NAMES, Z_LAYER_LOGOS, layerToAtlasUV, atlasUVToLayer };
