...
import type { DecalDrawParams, DecalLayout, GizmoHandle, GizmoZone } from '@types';

export type { DecalDrawParams, DecalLayout, GizmoHandle, GizmoZone };
...
export { buildDecalLayout, DECAL_CANVAS_H, DECAL_CANVAS_W, drawDecal, gizmoCursor, hitTestDecal };
